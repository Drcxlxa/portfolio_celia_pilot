...
export const Projects = () => {
    const projects = [
        ...
        { id: 4, title: 'Customisation css', title2: 'Alternance', categories: ['Alternance', 'Développement web', 'Design'], imageUrl: getImageUrl('projects/css.jpeg') },
        ...
        { id: 13, title: 'Hôtel Japonais', title2: 'Projet Universitaire', categories: ['Développement web'], imageUrl: getImageUrl('projects/sakura.png') },
